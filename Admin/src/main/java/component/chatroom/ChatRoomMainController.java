...
import component.main.ChatAppMainController;
...
public class ChatRoomMainController implements Closeable, HttpStatusUpdate, ChatCommands {
    ...
    @FXML
    private VBox actionCommandsComponent;
    @FXML
    private CommandsController actionCommandsComponentController;
    @FXML
    private GridPane chatAreaComponent;
    @FXML
